...
--------------------------------------------------`);
    ...
    try {
        const adminUser = await dbModels.Admin.findOne(criteria, projection).lean();
        ...
        const newMember = await dbModels.Admin(adminData)
...
--------------------------------------------------`);
    ...
    try {
        ...
        const adminUser = await dbModels.Admin.findOne(criteria);
